...
export class AdminController {
  ...
  async getAdminDetail(
    ...
    if (
      !this.canEditTarget(request.user.id, Number(request.user.role_id), id)
    ) {
  ...
  async updateAdminPassword(
    ...
    if (
      ...
      throw new ForbiddenException(
        "You are not allowed to edit this admin password.",
      );
    }
  ...
  async updateAdminProfileImage(
    ...
    if (
      ...
      throw new ForbiddenException(
        "You are not allowed to edit this admin image.",
      );
    }
  ...
  async updateEmailCredentials(
    ...
    const data = await this.settingsService.upsertSmtp(
      body,
