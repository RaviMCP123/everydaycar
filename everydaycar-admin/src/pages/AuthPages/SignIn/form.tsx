      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-6xl mx-auto">
        ...
        <div className="flex justify-center items-center">
          <div className="w-full max-w-lg p-4 sm:p-5 md:p-6 lg:p-8 bg-white/92 dark:bg-brand-900/90 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl border border-brand-200/70 dark:border-brand-800/60 relative overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#007BFF] via-[#0066cc] to-[#003366]"></div>
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
              <div className="space-y-4 sm:space-y-5 md:space-y-6">
                ...
                <div className="pt-1 sm:pt-2">
                  <Button
                    className="w-full h-11 sm:h-12 md:h-13 lg:h-14 text-xs sm:text-sm md:text-base font-bold rounded-lg sm:rounded-xl bg-[#003366] hover:bg-[#004080] !text-white shadow-lg hover:shadow-xl hover:shadow-[#003366]/30 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    size="md"
                    disabled={isLoading}
                  >
                    {isLoading ? (
