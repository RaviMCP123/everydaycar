      ...
      case "ring":
        return (
          <ColorRing
            ...
            colors={['#007BFF', '#0066cc', '#003366', '#007BFF', '#007BFF']}
          />
        );
      ...
      case "modern":
        return (
          <div className="relative">
            <div className="w-20 h-20 border-4 border-[#007BFF]/25 border-t-[#007BFF] rounded-full animate-spin"></div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-12 h-12 border-4 border-[#003366]/20 border-t-[#003366] rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '0.8s' }}></div>
            </div>
          </div>
        );
      ...
      case "pulse":
        return (
          <div className="flex items-center justify-center space-x-2">
            <div 
              className="w-4 h-4 bg-[#007BFF] rounded-full animate-bounce" 
              style={{ animationDelay: '0s', animationDuration: '0.6s' }}
            ></div>
            <div 
              className="w-4 h-4 bg-[#003366] rounded-full animate-bounce" 
        ...
        return (
          <div className="relative w-20 h-20">
            <div 
              ...
              style={{ 
                background: 'conic-gradient(from 0deg, #007BFF, #003366, #f4f7f9, #007BFF)',
              }}
            ></div>
